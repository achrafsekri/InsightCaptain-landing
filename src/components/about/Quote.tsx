      ...
      <blockquote className="text-center lg:mx-auto lg:w-3/5">
        <div className="mt-6 lg:mt-10">
          <p className="relative text-xl font-medium text-gray-800 sm:text-2xl md:text-3xl md:leading-normal">
            <svg
              className="absolute top-0 left-0 w-16 h-16 text-gray-200 transform -translate-x-8 -translate-y-8 sm:h-24 sm:w-24 "
              width="16"
              height="13"
              viewBox="0 0 16 13"
              fill="none"
            ...
            Our mission is to help small businesses understand their customers' needs by using AI to collect and analyze feedback
            </span>
          </p>
        </div>
        ...
        <footer className="mt-6">
          ...
          <div className="text-sm text-gray-500">founder & CEO | InsightCaptin</div>
        </footer>
      </blockquote>
      {/* <!-- End Blockquote --> */}
    </div>
