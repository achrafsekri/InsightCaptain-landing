...
import NormalPlanCard from "./plans/NormalPlanCard";
import PopularPlanCard from "./plans/PopularPlanCard";
...
const plans: Plan[] = [
  {
    ...
    monthly_price: 0,
    annual_price: 0,
    features: ["1 user", "15 GB storage", "Email support"],
    most_popular: false,
    href: "#",
  },
  {
      ...
      <div className="relative">
        <div className="max-w-[85rem] px-4 pt-10 sm:px-6 lg:px-8 lg:pt-14 mx-auto">
          ...
          <div className="max-w-2xl mx-auto mb-10 text-center">
            ...
            <p className="mt-2 text-gray-800 lg:text-lg ">
          ...
          <div className="flex items-center justify-center">
            <label
              ...
              className="min-w-[3.5rem] text-sm text-gray-600 mr-3 "
            >
              Monthly
            </label>
            ...
            <input
              ...
              className="relative shrink-0 w-[3.25rem] h-7 bg-gray-300 text-blue-600 checked:bg-none checked:bg-blue-600 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200  border-transparent ring-1 ring-transparent focus:border-blue-600 focus:ring-blue-600 ring-offset-white focus:outline-none appearance-none 
        ...
        before:inline-block before:w-6 before:h-6 before:bg-white before:translate-x-0 checked:before:translate-x-full before:shadow before:rounded-full before:transform before:ring-0 before:transition before:ease-in-out before:duration-200 "
            ...
            <label
              htmlFor="pricing-switch"
              className="min-w-[3.5rem] text-sm text-gray-600 ml-3 "
            >
              Annually
            </label>
          </div>
          ...
          <div className="grid gap-3 mt-6 md:mt-12 sm:grid-cols-2 lg:grid-cols-4 md:gap-6 lg:gap-3 xl:gap-6 lg:items-center">
            {plans.map((plan) => {
              if (plan.most_popular) {
                return <PopularPlanCard plan={plan} isMonthly={isMonthly} />;
              } else {
                return <NormalPlanCard plan={plan} isMonthly={isMonthly} />;
              }
            })}
          </div>
          {/* <!-- End Grid --> */}
        ...
        <div className="absolute top-1/2 left-1/2 -z-[1] transform -translate-y-1/2 -translate-x-1/2 w-[340px] h-[340px] border border-dashed border-blue-200 rounded-full "></div>
        <div className="absolute top-1/2 left-1/2 -z-[1] transform -translate-y-1/2 -translate-x-1/2 w-[575px] h-[575px] border border-dashed border-blue-200 rounded-full opacity-80 "></div>
        <div className="absolute top-1/2 left-1/2 -z-[1] transform -translate-y-1/2 -translate-x-1/2 w-[840px] h-[840px] border border-dashed border-blue-200 rounded-full opacity-60 "></div>
        <div className="absolute top-1/2 left-1/2 -z-[1] transform -translate-y-1/2 -translate-x-1/2 w-[1080px] h-[1080px] border border-dashed border-blue-200 rounded-full opacity-40 "></div>
      </div>
      {/* <!-- End Hero --> */}
    </div>
  );
