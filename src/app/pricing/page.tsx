    ...
    <>
      ...
      <div className="overflow-hidden">
        ...
        <div className="relative">
          <div className="max-w-[85rem] px-4 pt-10 sm:px-6 lg:px-8 lg:pt-14 mx-auto">
            ...
            <div className="max-w-2xl mx-auto mb-10 text-center">
              <h2 className="text-3xl font-bold leading-tight text-transparent md:text-4xl md:leading-tight lg:text-5xl lg:leading-tight bg-clip-text bg-gradient-to-r from-blue-600 to-fuchsia-700">
            ...
            <div className="flex items-center justify-center">
              ...
              <input
                type="checkbox"
                id="pricing-switch"
                className="relative shrink-0 w-[3.25rem] h-7 bg-gray-300 text-blue-600 checked:bg-none checked:bg-blue-600 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 border border-transparent ring-1 ring-transparent focus:border-blue-600 focus:ring-blue-600 ring-offset-white focus:outline-none appearance-none dark:bg-gray-700 dark:checked:bg-blue-600 dark:focus:ring-offset-gray-800
        ...
        before:inline-block before:w-6 before:h-6 before:bg-white before:translate-x-0 checked:before:translate-x-full before:shadow before:rounded-full before:transform before:ring-0 before:transition before:ease-in-out before:duration-200 dark:before:bg-gray-400"
            ...
            {/* <!-- Grid --> */}
            <div className="grid gap-3 mt-6 md:mt-12 sm:grid-cols-2 lg:grid-cols-4 md:gap-6 lg:gap-3 xl:gap-6 lg:items-center">
              {/* <!-- Card --> */}
              <div className="flex flex-col p-4 text-center bg-white border border-gray-200 rounded-2xl md:p-8 dark:bg-slate-900 dark:border-gray-700">
                ...
                <a
                  className="inline-flex items-center justify-center gap-2 px-4 py-3 mt-5 text-sm font-semibold text-blue-600 transition-all border-2 border-blue-600 rounded-lg hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:text-blue-500 dark:border-blue-600 dark:hover:border-blue-700"
                  href="#"
                >
                  Get started
                </a>
              ...
              {/* <!-- Card --> */}
              <div className="flex flex-col p-4 text-center bg-white border-2 border-blue-600 shadow-xl rounded-2xl md:p-8 dark:bg-slate-900 dark:border-blue-700">
                <p className="mb-3">
                ...
                <a
                  className="inline-flex items-center justify-center px-4 py-3 mt-5 text-sm font-medium text-center text-white transition bg-blue-600 rounded-lg gap-x-3 hover:bg-blue-700 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-gray-800"
          ...
          <div className="absolute top-1/2 left-1/2 -z-[1] transform -translate-y-1/2 -translate-x-1/2 w-[340px] h-[340px] border border-dashed border-blue-200 rounded-full dark:border-blue-600/60"></div>
          <div className="absolute top-1/2 left-1/2 -z-[1] transform -translate-y-1/2 -translate-x-1/2 w-[575px] h-[575px] border border-dashed border-blue-200 rounded-full opacity-80 dark:border-blue-600/60"></div>
          <div className="absolute top-1/2 left-1/2 -z-[1] transform -translate-y-1/2 -translate-x-1/2 w-[840px] h-[840px] border border-dashed border-blue-200 rounded-full opacity-60 dark:border-blue-600/60"></div>
          <div className="absolute top-1/2 left-1/2 -z-[1] transform -translate-y-1/2 -translate-x-1/2 w-[1080px] h-[1080px] border border-dashed border-blue-200 rounded-full opacity-40 dark:border-blue-600/60"></div>
        </div>
        {/* <!-- End Hero --> */}
      </div>
      {/* <!-- Comparison Table --> */}
      <div className="relative">
        <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 md:py-14 lg:py-20 mx-auto">
          ...
          {/* <!-- Header --> */}
          <div className="sticky top-0 left-0 hidden py-2 lg:block bg-white/60 backdrop-blur-md dark:bg-slate-900/60">
            {/* <!-- Grid --> */}
          ...
          <div className="space-y-4 lg:space-y-0">
            ...
            <ul className="grid lg:grid-cols-6 lg:gap-6">
              ...
              <li className="lg:col-span-2 pb-1.5 lg:py-3">
                <span className="text-sm font-semibold text-gray-800 lg:font-normal dark:text-gray-200">
                  Number of seats
                </span>
              </li>
              {/* <!-- End Item --> */}
              ...
              <li className="col-span-1 py-1.5 lg:py-3 border-b border-gray-200 dark:border-gray-700">
                <div className="grid grid-cols-2 md:grid-cols-6 lg:block">
                  <span className="text-sm text-gray-800 lg:hidden md:col-span-2 dark:text-gray-200">
                    Free
                  </span>
